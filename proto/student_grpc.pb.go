...
type StudentServiceClient interface {
	...
	SetStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*SetStudentResposne, error)
}
...
func (c *studentServiceClient) SetStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*SetStudentResposne, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetStudentResposne)
...
type StudentServiceServer interface {
	...
	SetStudent(context.Context, *Student) (*SetStudentResposne, error)
...
func (UnimplementedStudentServiceServer) SetStudent(context.Context, *Student) (*SetStudentResposne, error) {
