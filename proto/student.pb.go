...
type SetStudentResposne struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SetStudentResposne) Reset() {
	*x = SetStudentResposne{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetStudentResposne) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetStudentResposne) ProtoMessage() {}

func (x *SetStudentResposne) ProtoReflect() protoreflect.Message {
	mi := &file_student_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetStudentResposne.ProtoReflect.Descriptor instead.
func (*SetStudentResposne) Descriptor() ([]byte, []int) {
	return file_student_proto_rawDescGZIP(), []int{2}
}

func (x *SetStudentResposne) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_student_proto_rawDesc = []byte{
	...
	0x74, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x73, 0x6e, 0x65,
	0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67,
	0x6f, 0x2d, 0x70, 0x6c, 0x61, 0x74, 0x7a, 0x69, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x3b, 0x73, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_student_proto_goTypes = []interface{}{
	...
	(*SetStudentResposne)(nil), // 2: student.SetStudentResposne
}
var file_student_proto_depIdxs = []int32{
	...
	2, // 3: student.StudentService.SetStudent:output_type -> student.SetStudentResposne
...
func file_student_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_student_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetStudentResposne); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
